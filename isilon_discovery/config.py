...
def load_secrets() -> None:
    """
    Load .env into os.environ if an env file exists.

    This allows containerized deployments to supply secrets directly via
    environment variables without requiring a mounted env file.
    """
    try:
        dotenv_path = _resolve_env_file()
